	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.links}>
				...
				<a
					href="https://www.linkedin.com/in/amar-codingenthusiast/"
					target="_blank"
					rel="noreferrer"
					title="LinkedIn"
				>
				...
				<a
					href="mailto:amar.codingenthusiast@gmail.com"
					target="_blank"
					rel="noreferrer"
					title="Email"
				>
			...
			<p>&copy; 2024 Amar Kumar. All rights reserved.</p>
		</div>
	);
};
